...
function Reviews() {
  return (
    ...
    <h1 className='customm'>FROM OUR CUSTOMERS</h1>
    <Carousel className='mt-5'>
      <Carousel.Item interval={1000}>
        <ExampleCarouselImage />
        <Carousel.Caption className='mt-2'>
          <h3 className='starr'><IoStarOutline /><IoStarOutline /><IoStarOutline /><IoStarOutline /><IoStarOutline /></h3>
          <h1 className='mt-4'>🧕</h1>
          <h5 className='revieew1 mt-5'>Christina M. /From Chennai</h5>
          <p class="revieew2">Clothing are addicting! Premium formal wear with excellent finishing and materials</p>
        </Carousel.Caption>
      </Carousel.Item>
