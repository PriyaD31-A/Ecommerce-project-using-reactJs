...
const TraditionalCart = ({search1,handleClick}) => {
                 ...
                 <div className='row row-cols-2 row-cols-md-3 row-cols-lg-6 justify-content-around ms-2'>
                     {
                         searchDress1.map((user2) => (
                           ...
                           <Card.Body>
                             ...
                             <Button variant="primary cart p-0 mt-2" onClick={() => handleClick(user2)}>Add to cart</Button>
...
export default TraditionalCart
