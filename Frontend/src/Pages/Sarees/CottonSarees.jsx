          ...
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-5 mt-5 justify-content-around ms-2">
            {typee4.map((users3) => (
              <div className="col p-3">
                <Card className="align-items-center apply"  style={{ height: "330px",width:"100%"}}>
                  <Card.Img variant="top" src={link3+users3.Category_Image} style={{ width: "70%", height: "170px", padding: "10px" }}/>
                  <Card.Body>
