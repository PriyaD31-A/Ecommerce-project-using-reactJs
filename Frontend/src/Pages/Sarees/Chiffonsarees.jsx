          ...
          <div className="row row-cols-1 row-cols-md-2 row-cols-lg-5 mt-5 justify-content-around ms-2">
            {typee5.map((users4) => (
              <div className="col p-3">
                <Card className="align-items-center apply"  style={{ height: "330x",width:"100%"}}>
                  <Card.Img variant="top" src={link4+users4.Category_Image} style={{ width: "70%", height: "180px", padding: "10px" }}/>
                  <Card.Body>
